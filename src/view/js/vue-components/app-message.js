Vue.component('app-message', {
  ...
  template: `
    <div class="slds-notify_container">
      <div class="slds-notify slds-notify_toast" v-bind:class="{ 'slds-theme_error' : message.type=='error', 'slds-theme_success' : message.type=='success' }" role="alert">
        <span class="slds-assistive-text">message</span>
        <span class="slds-icon_container slds-icon-utility-error slds-m-right_small slds-no-flex slds-align-top">
          <svg class="slds-icon slds-icon_small" aria-hidden="true">
            <use xlink:href="components/salesforce-lightning-design-system/assets/icons/utility-sprite/svg/symbols.svg#error"></use>
          </svg>
        </span>
